...
export default function ImageEditingSuite() {
  ...
  const [currentRoute, setCurrentRoute] = useState("restore")
    ...
    <div className="w-full min-h-screen bg-gray-50 p-6 space-y-6 mt-20">
      {currentRoute === "restore" && (
        <div className="space-y-6">
          ...
          <div className="space-y-4 min-w-2xl mx-auto">
            <Button
      ...
      {currentRoute === "background-remove" && (
        <div className="space-y-6">
          <div className="space-y-2">
